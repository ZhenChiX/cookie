...
var allLocations = [];
var cookiesTable = document.getElementById('SCtable');
...
stCenter.calcCustomersEachHour = function () {
...
stCenter.calcCookiesSoldEachHour = function () {
    stCenter.calcCustomersEachHour();
...
stCenter.render = function () {
    stCenter.calcCookiesSoldEachHour();
    // grab the parent from the DOM
    var tbEl = document.getElementById('SCtable')
    for (var i = 0; i < hours.length; i++) {
        // create an element
        var tdEl = document.createElement('td');
